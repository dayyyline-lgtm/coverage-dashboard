...
GROUPS = {
    ...
    #
    # 표기: 일본 커뮤니티는 약칭 「アスオラ」를 훨씬 많이 쓴다. 정식명도 같이 넣어
    #       어느 쪽이 신호를 잡는지 보고, 안 잡히는 쪽은 다음에 뺀다.
    #       (티니핑에서 ティーニーピン 이 0/52 였던 전례가 있어 표기는 반드시 실측한다)
    # 기간: 정식명 공개 전은 전부 0 이라 26주만 본다.
    "아스트라에 오라티오": {
        "geos": [
            {"label": "한국",        "geo": "KR", "kw": "아스트라에 오라티오", "src": "naver"},
            {"label": "일본(약칭)",   "geo": "JP", "kw": "アスオラ"},
            {"label": "일본(정식명)", "geo": "JP", "kw": "アストラエ・オラティオ"},
            {"label": "일본(중점없음)", "geo": "JP", "kw": "アストラエオラティオ"},
            {"label": "일본(라틴)",   "geo": "JP", "kw": "Astrae Oratio"},
            {"label": "일본(개발사)", "geo": "JP", "kw": "ディナミス・ワン"},
        ],
        "freq": "week",
        "n": 26,
    },
