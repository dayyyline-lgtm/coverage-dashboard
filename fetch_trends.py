...
GROUPS = {
    ...
    #   ティニピン 52 · ハチュピン 34 · 愛のハチュピン 1 · キャッチ!ティニピン 0 · ティーニーピン 0
    # 정식명 キャッチ!ティニピン 은 정작 검색량이 미달이고, 다들 줄여서 ティニピン 으로 찾는다.
    "일본 티니핑·하츄핑": {
        "geos": [
            {"label": "티니핑(시리즈)", "geo": "JP", "kw": "ティニピン"},
            {"label": "하츄핑(극장판)", "geo": "JP", "kw": "ハチュピン"},
        ],
        "freq": "week",
    },
